...
public class FuncionarioController implements Serializable {
    ...
    public FuncionarioEntity getPessoa() {
        return pessoa;
    }

    public void setPessoa(FuncionarioEntity pessoa) {
        this.pessoa = pessoa;
    }

    public List<FuncionarioEntity> getPessoaList() {
        return ejbFacade.buscarTodos();
    }

    public void setPessoaList(List<FuncionarioEntity> pessoaList) {
